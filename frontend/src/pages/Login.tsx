  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-20">
        ...
        <Button variant="ghost" size="icon" className="absolute right-4 top-4" onClick={toggleTheme} aria-label="Toggle theme">
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Full page navigation on purpose — this needs to leave the SPA
                so the backend can redirect to Google/GitHub and back. */}
            <a
              href={googleLoginUrl()}
              className="inline-flex h-9 w-full items-center justify-center gap-2 rounded-md border border-input bg-background px-4 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground"
            >
          ...
          <p className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <span className="font-medium">Ask your admin to invite you.</span>
          </p>
        </div>
      </div>
    </div>
